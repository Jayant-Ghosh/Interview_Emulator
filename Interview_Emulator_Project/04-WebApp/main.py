...
def video() :
    ...
    flash('You will have 120 seconds to discuss the topic mentioned above. Due to restrictions, we are not able to redirect you once the video is over. Please move your URL to /video_dash instead of /video_1 once over. You will be able to see your results then.')
...
def audio_index():
    ...
    # Flash message
    flash("After pressing the button above, you will have 30 seconds to answer the question.")
